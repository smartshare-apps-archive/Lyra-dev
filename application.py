...
application.config[
    'ctl'] = ControlPanel()  # this instance of ControlPanel can be accessed through the application context so blueprints can use it
application.config[
    'store_ctl'] = Store()  # this instance of Store can be accessed through the application context so blueprints can use it
application.config[
    'auth_ctl'] = Auth()  # this instance of Store can be accessed through the application context so blueprints can use it
