...
def addProduct():
    ...
    productData["stripe_id"] = product.stripe_manager.createProduct(
        productData)  # create a stripe listing for the product
    productData["VariantSKU"] = product.stripe_manager.createVariant(
        productData)  # create a stripe listing for the product
...
def addProductVariant():
    ...
    variantData["stripe_id"] = product.stripe_manager.createVariant(productData,
                                                                    variant_data=variantData)  # create a stripe listing for the product
...
def getCollectionProducts():
    ...
    collectionProductIDList = product.loadProductsInCollection(collection_conditions, collection_policy,
                                                               productDatabase)
