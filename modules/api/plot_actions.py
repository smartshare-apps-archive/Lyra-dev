...
def generate_plot(tile_id):
    ...
    helper_instance = tile_data["helper_script"](tile_data["requirements"]["data_endpoint"],
    ...
    tile_template = render_template("control_panel/dashboard/tile_templates/base_plot.html",
